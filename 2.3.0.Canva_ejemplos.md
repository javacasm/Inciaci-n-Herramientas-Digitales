...
### Cómo Crear en Canva:
1. **Inicio de Sesión:**
   - Inicia sesión en tu cuenta de Canva o crea una nueva cuenta.

2. **Crear un Diseño Personalizado:**
   - Selecciona "Crear un diseño personalizado" e ingresa las dimensiones adecuadas para tu póster (por ejemplo, tamaño de papel estándar).

3. **Añadir Elementos Gráficos:**
   - Utiliza las herramientas de Canva para añadir ilustraciones, gráficos, imágenes y texto según la estructura propuesta.

4. **Diseño Atractivo:**
   - Aprovecha las funciones de diseño de Canva para asegurarte de que tu póster sea visualmente atractivo y fácil de entender.

5. **Interactividad (Opcional):**
   - Puedes generar un código QR para enlazar a recursos externos y fomentar la exploración adicional.

6. **Guarda y Comparte:**
   - Una vez completado, guarda tu diseño y compártelo con tus estudiantes o imprímelo para su uso en el aula.

Este ejemplo utiliza Canva para crear un póster educativo atractivo y educativo sobre el espacio, destacando los planetas del sistema solar. Canva es una herramienta versátil que permite la creatividad y la presentación visual de la información de manera efectiva.

...
1. **Panel de Control:**
   ...
   - En Genially nos encontramos con una banda lateral donde tenemos distintas opciones que podemos utilizar. Vamos a enumerar algunas de las opciones que disponibles para usar con la cuenta Genially Educación.

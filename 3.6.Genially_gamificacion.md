...
![](./images/icono-genially_gamificacion.png)
...
* **Scape Rooms** donde los participantes van moviéndose entre distintas partes del genially, como si se movieran en distintas habitaciones resolviendo enigma, encontrando objetos y obteniendo las **llaves** para conseguir desbloquear otros lugares y objetos y finalmente alcanzar la salida. Normalmente incluyen un mapa para ver por donde nos movemos.

[![](https://raw.githubusercontent.com/javacasm/Iniciacion-Herramientas-Digitales-Aula/main/images/portada-3.6.0.Ejemplos-gamificacion.png)](https://drive.google.com/file/d/141DnFGvOZuFIOACmIt8SYcYsIFYTR8EK/view?usp=drivesdk)
...
* Al seleccionar los diferentes tipos de plantillas encontramos que aparece "Gamificiación"
...
![](./images/icono-genially_quiz.png)
...
* Usando el elmento "Pregunta Interactiva" que nos crea directamente los botones de las respuestas y el mecanismo de acierto/error, ahorrando trabajo.
...
[![](https://raw.githubusercontent.com/javacasm/Iniciacion-Herramientas-Digitales-Aula/main/images/portada-3.6.1.Quizz-preguntas-a-mano.png)](https://drive.google.com/file/d/1zcV2H8pNLf5FJmDmDCRXQe6i22lE7Ljx/view?usp=drivesdk)
...
* En estas presentaciones tenemos que construir el flujo entre las diaposivitas
* Para contruir cada diapositiva añadimos sus botones y cada uno tiene implementada la interactividad para enviar a  una u otra parte de presentación
...
[![](https://raw.githubusercontent.com/javacasm/Iniciacion-Herramientas-Digitales-Aula/main/images/portada-3.6.1.Quizz-preguntas-interactivas.png)](https://drive.google.com/file/d/174nv8oIVPslh1mTfVGy5vllVeFFY4MFG/view?usp=drivesdk) 
...
* Estas propiedades afectan a todas los elementos "Preguntas Interactivas" de la presentación. Podemos permitir que se va un resultado de cúantos aciertos llevamos y si en caso de error se repite o no
...
![](./images/icono-genially_juego-mesa.png)

Vamos a ver ejemplos de gamificiación tipo Juego

[![](https://raw.githubusercontent.com/javacasm/Iniciacion-Herramientas-Digitales-Aula/main/images/portada-3.6.2.ejemplo-juego-movible.png)](https://drive.google.com/file/d/15c95_Zeb6MKubFHb6k07BSnMsir_tF4G/view?usp=drivesdk)

[Vídeo sobre gamificación tipo Juego](https://drive.google.com/file/d/15c95_Zeb6MKubFHb6k07BSnMsir_tF4G/view?usp=drivesdk)

En este vídeo hemos visto:

* Las gamificaciones tipo juego utilizan elementos movibles que el mueve el propio usuario manualmente y no existe una validación de lo que este ha hecho. Se suele mostrar una ventana con el resultado para que el usuario lo compruebe
...
* Otro ejemplo podría ser un "Sudoku" donde tenemos que colocar los números en sus sitio. En ese caso la solución muestra una imagen de la respuesta correcta.
...
* Si hacemos un ejemplo donde un elemento se puede arrastrar varias veces, como un Sudoku o un "3 en raya" tendremos que incluir tantos elementos iguales como necesitemos, 9 de cada en el Sudoku o tantas fichas de un color como quepan en nuestro "3 en raya". Los pondremos unos encimas de otros.

### ScapeRoom con Genially

![](./images/icono-genially_escape-room.png)
...
[![](https://raw.githubusercontent.com/javacasm/Iniciacion-Herramientas-Digitales-Aula/main/images/portada-3.6.3.scaperoom-breakout.png)](https://drive.google.com/file/d/10rKSRQopeIkINikH281EJn9yTtIKO791/view?usp=drivesdk)
...
* En Genially se tratará de una presentación donde tenemos que pulsar sobre detereminados objetos que desbloquean o muestran otros que nos darán pistas y detalles para poder movernos entre las diapositivas de nuestra presentación.
* Se suele implementar a la antigua usanza, con botones que nos mueven entre diapositivas
* Veamos el ejemplo de [este Escap Room en la granja](https://view.genial.ly/6376171b2cf1e00011b0f063/interactive-content-escape-room-granja)
...
* Cuando hemos recoletado todos los disponibles, se desbloquea otra zona de la granja, lo que se muestra en la diapositiva que actúa como mapa
...
* Para darle más interatividad se reproducen sonidos y hay pantallas para los errores
* Otro típo típico de Escape Room muestra un mapa de un lugar, como [este de un museo](https://view.genial.ly/65b38ae8fa276d00152abd59/interactive-content-escape-room-museo)
...
* En cada una de las salas tenemos que ir pulsando sobre elementos y al medida que contestamos se van mostrando elementos, cuando ya se han mostrado todos podremos pasar a la siguiente zona, se activará un botón que nos permite saltar a la siguiente "Zona"
...
* En este ejemplo, el mapa no es interactivo, pero podíamos hacerlo, incluyendo botones que nos llevan a las disintas "Salas"
* Podemos hacer diapositivas con las típicas preguntas o también con una imagen que se van complentando, obviamente nosotros nos encargamos de generar esa imagen en distintos puntos de visualización

...
* Educaplay es una aplicación web donde podemos crear actividades educativas a partir de plantillas de actividades como:
   ...
   * El típico rosco de preguntas (al estilo de pasaplabra)
...
![](./images/educaplay-compartir.png)   
...
En este vídeo hemos visto las distintas actividades que incluye Educaplay. Vamos a enumararlas y comentar aquellas no son evidentes por su nombre

![](./images/educaplay-actividades.png)
![](./images/educaplay-actividades2.png)
* Preguntas Sí o No
...
![](./images/educaplay-ranita.png)

* Test
* Rosco de preguntas: típico rosco de preguntas
![](./images/educaplay-rosco.png)
...
![](./images/educaplay-relacionar.png)
...
[![](https://raw.githubusercontent.com/javacasm/Iniciacion-Herramientas-Digitales-Aula/main/images/portadaN-5.2-educaplay-creando.png)](https://youtu.be/kXmZoIPOPb4)
...
* Usando la  IA podemos darle un título, un enlace o un fragmento de texto y se encargará de crear el crucigrama con un creador automático. 
* El resultado no está mal, aparece el crucigrama con las definiciones correspondientes de cada término. Les podemos añadir imágenes o grabar sonidos y podemos editar el texto.
* El resultado final de IA con este crucigrama ha sido bastante bueno.
   ...
   - Vamos a ir añadiendo más palabras con sus definiciones, sucesivamente
   y Educaplay nos va construyendo poco a poco el crucigrama, si no nos gusta el diseño, lo podemos ir modificando.
...
Podemos previsualizar una vez esté listo el crucigrama y cambiar lo que queramos nos va a dejar el juego listo para “Publicar”. 

En otro tipo de ejemplos, lo que tenemos es que ir completando, vamos a hacer un rosco. Página inicial y vamos a "Crear actividad", seleccionamos el tipo de juego:

   * Rosco de Palabras: donde cada palabra corresponde a una palabra que tienen que adivinar.
...
Las actividades con Educaplay son diferentes y muy divertidas.
